...
console.log("Electronics componentd loaded");
...
const Electronics = () => {
  ...
  useEffect(() => {
    axios
      .get("http://85.222.120.170:15118/api/products/categories?description=Electronics")
      .then((res) => {
  ...
  return (
    <>
      ...
      {isLoading && <p>Electronics loading, please wait.</p>}
