...
console.log("Healthy componentd loaded");
...
const Healthy = () => {
  ...
  useEffect(() => {
    axios
      .get("http://85.222.120.170:15118/api/products/categories?description=Healthy")
      .then((res) => {
  ...
  return (
    <>
      ...
      {isLoading && <p>Healthy loading, please wait.</p>}
